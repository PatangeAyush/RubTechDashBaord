<%@ Page Title="" Language="C#" MasterPageFile="~/Rubtech.Master" AutoEventWireup="true" CodeBehind="vacancy.aspx.cs" Inherits="RubTechDashBaord.vacancy" %>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header p-4 pb-0 m-2">
                 <h1 class="modal-title fs-4 fw-medium" id="addContactModalLabel">Edit Vacancy</h1>
             ...
             <div class="modal-body pt-0 p-4">
                 <form id="contactlist-form" class="needs-validation p-2" >
                     ...
                     <div class="d-flex flex-column gap-3">
                         <div>
                            <label for="basiInput" class="form-label">Vacancy Heading </label>
                            <input type="text" class="form-control rounded-pill" id="v-heading" placeholder="Enter Vacancy Heading">
                         </div>
                         
                         <div>
                          <label for="labelInput" class="form-label">Vacancy Icon</label>
                          ...
                          <div>
                          <label for="placeholderInput" class="form-label">Vacancy Document</label>
                         ...
                         <div class="col-xl-12">
                             <div class="card">
                                 <div class="card-header align-items-center d-flex">
                                     <h4 class="card-title mb-0 flex-grow-1">Total Vacancy</h4>
                                             ...
                                             <tbody>
                                                 <tr>
                                                     ...
                                                     <td>
                                                       ...
                                                       <img src="assets/images/icons/job.png" alt="Vacancy" class="avatar-md img-thumbnail" />  
                                                         </div>
                                                     </td>
