MRAI.service('myStorageService', ['$http', 'localStorageService', '$rootScope', function ($http, localStorageService, $rootScope) {
    ...
    this.removeMyStorage = function (keyName) {
        ...
        if (myStorageAll[keyName]) //found
        {
            ...
            localStorageService.set('myStorage', myStorageAll);
            $rootScope.use1 = undefined;
            $rootScope.use12 = undefined;
        }
        return true;
    ...
    this.setCookie = function (KeyName, KeyVal) {
        // swal('Cookie Supported' + localStorageService.cookie.set(KeyName, KeyVal, 1));
