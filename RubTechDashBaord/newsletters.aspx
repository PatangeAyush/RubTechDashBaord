<%@ Page Title="" Language="C#" MasterPageFile="~/Rubtech.Master" AutoEventWireup="true" CodeBehind="newsletters.aspx.cs" Inherits="RubTechDashBaord.newsletter" %>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header p-4 pb-0 m-2">
                <h1 class="modal-title fs-4 fw-medium" id="addContactModalLabel">Edit Newsletters</h1>
            ...
            <div class="modal-body pt-0 p-4">
                <form id="contactlist-form" class="needs-validation p-2" >
                    ...
                    <div class="d-flex flex-column gap-3">
                        <div>
                           <label for="basiInput" class="form-label">Newsletters Heading </label>
                           <input type="text" class="form-control rounded-pill" id="v-heading" placeholder="Enter Newsletters Heading">
                        </div>
                        
                        <div>
                         <label for="labelInput" class="form-label">Newsletters Image</label>
                         ...
                         <div>
                         <label for="placeholderInput" class="form-label">Newsletters Document</label>
                        ...
                        <div>
                            ...
                            <div class="invalid-feedback">
                                Please enter Newsletters Heading. 
                                 </div>
                        </div>
         ...
         <div class="row">
             <div class="col-12">
                 <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                     <h4 class="mb-sm-0">Add Newsletters</h4>
                         ...
                         <div class="col-xl-12">
                             <div class="card">
                                 <div class="card-header align-items-center d-flex">
                                     <h4 class="card-title mb-0 flex-grow-1">Total Newsletters</h4>
                                 ...
                                 <div class="card-body">
                                     <div class="table-responsive table-card">
                                         <table class="table table-success table-striped align-middle table-nowrap mb-0">
                                             <thead>
                                                 <tr>
                                                     <th scope="col">Newsletters Name</th>
                                                     <th scope="col">Newsletters Image</th>
                                       ...
                                       <img src="assets/images/icons/newsletter-thumb.jpg" alt="Newsletters" class="avatar-md img-thumbnail" />  
                                                         </div>
                                                     </td>
