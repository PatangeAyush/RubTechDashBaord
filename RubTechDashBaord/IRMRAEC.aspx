<%@ Page Title="" Language="C#" MasterPageFile="~/Rubtech.Master" AutoEventWireup="true" CodeBehind="IRMRAEC.aspx.cs" Inherits="RubTechDashBaord.IRMRAEC" %>
...
<!-- Add IRMRA East Centre Showcased Portfolio... Popup Modal Start-->

<div class="modal fade" id="addContactModal" tabindex="-1" aria-labelledby="addContactModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header p-4 pb-0 m-2">
                <h1 class="modal-title fs-4 fw-medium" id="addContactModalLabel">Edit IRMRA East Centre Showcased Portfolio...</h1>
 ...
 <!-- Add IRMRA East Centre Showcased Portfolio... Popup Modal End-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">IRMRA East Centre Showcased Portfolio...</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item active">IRMRA East Centre Showcased Portfolio...</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row gy-4">
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    <label for="basiInput" class="form-label">IRMRA East Centre Showcased Portfolio...</label>
                                    <input type="text" class="form-control rounded-pill" id="v-heading" placeholder="Enter Heading">
                                </div>
                            </div>
                            <!--end col-->
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">IRMRA East Centre Showcased Portfolio...</h4>
                                         ...
                                         <img src="assets/images/icons/tender-quotation.png" alt="Report" class="avatar-md img-thumbnail" />  
                                                ...
                                                <!-- end tr -->
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                              <img src="assets/images/icons/tender-quotation.png" alt="IRMRA East Centre Showcased Portfolio..." class="avatar-md img-thumbnail" /> 
                                                        </div>
                                                    </td>
                                                    <td>Project-Manager.pdf</td>
