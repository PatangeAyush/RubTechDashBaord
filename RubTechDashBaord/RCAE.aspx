<%@ Page Title="" Language="C#" MasterPageFile="~/Rubtech.Master" AutoEventWireup="true" CodeBehind="RCAE.aspx.cs" Inherits="RubTechDashBaord.RC_E" %>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header p-4 pb-0 m-2">
                <h1 class="modal-title fs-4 fw-medium" id="addContactModalLabel">Edit IRMRA 24th Rubber Conference & Expo</h1>
            ...
            <div class="modal-body pt-0 p-4">
                <form id="contactlist-form" class="needs-validation p-2" >
                    ...
                    <div class="d-flex flex-column gap-3">
                        <div>
                           <label for="basiInput" class="form-label">Enter Heading </label>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add IRMRA 24th Rubber Conference & Expo</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item active">IRMRA 24th Rubber Conference & Expo</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row gy-4">
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    <label for="basiInput" class="form-label">IRMRA 24th Rubber Conference & Expo </label>
                                    <input type="text" class="form-control rounded-pill" id="v-heading" placeholder="Enter  Heading">
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label for="labelInput" class="form-label">Enter Icon</label>
                                    <p class="text-format">Upload Image <code>jpg, jpeg, png</code> Format Only.</p>
                                   <p class="text-format"> Maximum Upload Image Size - <code>20kb</code></p>
                                    <input type="file" class="form-control rounded-pill" id="icon">
                                </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                   <label for="placeholderInput" class="form-label">Enter Document</label>
                                   <p class="text-format">Upload Image <code>pdf, xlsx, docs</code> Format Only.</p>
                                   <p class="text-format"> Maximum Upload Image Size - <code>1mb</code></p>
                                    <input type="file" class="form-control rounded-pill" id="document">
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">IRMRA 24th Rubber Conference & Expo</h4>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <img src="assets/images/icons/tender-quotation.png" alt="IRMRA 24th Rubber Conference & Expo" class="avatar-md img-thumbnail" />  
                                                        </div>
                                                    </td>
