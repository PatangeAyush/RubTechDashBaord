<%@ Page Title="" Language="C#" MasterPageFile="~/Rubtech.Master" AutoEventWireup="true" CodeBehind="news.aspx.cs" Inherits="RubTechDashBaord.news" %>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header p-4 pb-0 m-2">
                 <h1 class="modal-title fs-4 fw-medium" id="addContactModalLabel">Edit News</h1>
             ...
             <div class="modal-body pt-0 p-4">
                 <form id="contactlist-form" class="needs-validation p-2" >
                     ...
                     <div class="d-flex flex-column gap-3">
                         <div>
                            <label for="basiInput" class="form-label">News Heading </label>
                            <input type="text" class="form-control rounded-pill" id="v-heading" placeholder="Enter News Heading">
                         </div>
                         
                         <div>
                          <label for="labelInput" class="form-label">News Image</label>
                          ...
                          <div>
                          <label for="placeholderInput" class="form-label">News Document</label>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Total News</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-card">
                                      ...
                                      <img src="assets/images/icons/news-thumb.jpg" alt="News" class="avatar-md img-thumbnail" />  
                                                        </div>
                                                    </td>
