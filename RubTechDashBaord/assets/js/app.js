!(function () {
    ...
    function h() {
        ...
        !t ||
            ...
            ((n = document.createElement("ul")).innerHTML = '<a href="index.html" class="logo"><img src="assets/images/logo-sm.png" alt="" height="22"></a>'),
    ...
    function z(e) {
        if (e == e) {
            ...
            switch (e["data-bs-theme"]) {
                case "light":
                    x("data-bs-theme", "light"), document.documentElement.setAttribute("data-bs-theme", "light"), sessionStorage.setItem("data-bs-theme", "light");
                    break;
                case "dark":
                    x("data-bs-theme", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"), sessionStorage.setItem("data-bs-theme", "dark");
                    break;
                default:
                    sessionStorage.getItem("data-bs-theme") && "dark" == sessionStorage.getItem("data-bs-theme")
                        ? (sessionStorage.setItem("data-bs-theme", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"), x("data-bs-theme", "dark"))
                        : (sessionStorage.setItem("data-bs-theme", "light"), document.documentElement.setAttribute("data-bs-theme", "light"), x("data-bs-theme", "light"));
            }
            ...
            e == t.value ? (t.checked = !0) : (t.checked = !1),
                t.addEventListener("change", function () {
                    ...
                    document.documentElement.setAttribute(a, t.value),
                        ...
                        "data-bs-theme" == a && "light" == t.value
                            ? (document.getElementById("topbar-color-light").click(), document.getElementById("sidebar-color-light").click())
                            : "data-bs-theme" == a && "dark" == t.value && (document.getElementById("topbar-color-dark").click(), document.getElementById("sidebar-color-dark").click()),
    ...
    function C(e, t, a, n) {
        ...
        n.setAttribute(e, t), o && (document.getElementById(a).click(), document.getElementById("sidebar-color-" + t).click(), document.getElementById("topbar-color-" + t).click());
    }
    function H() {
    ...
    sessionStorage.getItem("defaultAttribute")
                    ...
                    ? (s.classList.add("show"),
                      ...
                      Array.from(t).forEach(function (e) {
                          ...
                          e.querySelector("h6")
                              ...
                              n && (n.includes(o) ? (e.classList.add("d-block"), e.classList.remove("d-none")) : (e.classList.remove("d-block"), e.classList.add("d-none"))),
        ...
        document.querySelectorAll("#light-dark-mode .dropdown-item").forEach(function (t) {
            t.addEventListener("click", function (e) {
                l.hasAttribute("data-bs-theme") && "light" == t.getAttribute("data-mode")
                    ? (C("data-bs-theme", "light", "layout-mode-light", l), sessionStorage.setItem("data-layout-auto", "false"))
                    : l.hasAttribute("data-bs-theme") && "dark" == t.getAttribute("data-mode")
                    ? (C("data-bs-theme", "dark", "layout-mode-dark", l), sessionStorage.setItem("data-layout-auto", "false"))
                    : l.hasAttribute("data-bs-theme") &&
                      "auto" == t.getAttribute("data-mode") &&
                      (window.matchMedia("(prefers-color-scheme: dark)").matches ? C("data-bs-theme", "dark", "layout-mode-dark", l) : C("data-bs-theme", "light", "layout-mode-light", l), sessionStorage.setItem("data-layout-auto", "true")),
        ...
        Array.from(m).forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((t = {}),
                  (n = e.attributes)["data-date-format"] && (t.dateFormat = n["data-date-format"].value.toString()),
...
mybutton &&
    ...
    setInterval(() => {
        var e = new Date(),
            ...
            a = e.getHours(),
            n = 12 <= a ? " PM" : " AM",
            a = ("0" + (a % 12)).slice(-2) + ":" + ("0" + e.getMinutes()).slice(-2) + n;
