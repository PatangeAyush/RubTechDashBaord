<%@ Page Title="" Language="C#" MasterPageFile="~/Rubtech.Master" AutoEventWireup="true" CodeBehind="tender-quotation.aspx.cs" Inherits="RubTechDashBaord.tender_quotation" %>
         ...
         <div class="row">
             <div class="col-12">
                 <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                     <h4 class="mb-sm-0">Add Tender & Quotation</h4>

                     <div class="page-title-right">
                         <ol class="breadcrumb m-0">
                             <li class="breadcrumb-item"><a href="dashboard.aspx">Dashboard</a></li>
                             <li class="breadcrumb-item active">Tender & Quotation</li>
                         </ol>
                     </div>
                 </div>
             </div>
                         ...
                         <div class="col-xl-12">
                             <div class="card">
                                 <div class="card-header align-items-center d-flex">
                                     <h4 class="card-title mb-0 flex-grow-1">Total Tender & Quotation</h4>
                                 ...
                                 <div class="card-body">
                                     <div class="table-responsive table-card">
                                         <table class="table table-success table-striped align-middle table-nowrap mb-0">
                                             <thead>
                                                 <tr>
                                                     <th scope="col">Tender & Quotation Name</th>
                                                     <th scope="col">Tender & Quotation Icon</th>
                                             ...
                                             <tbody>
                                                 <tr>
                                                     ...
                                                     <td>
                                                       ...
                                                       <img src="assets/images/icons/tender-quotation.png" alt="Tender & Quotation" class="avatar-md img-thumbnail" />  
                                                         </div>
                                                     </td>
